module.exports = {
   billingFirstName: '//input[@id="billing_first_name"]',
   billingLastName: '//input[@id="billing_last_name"]',
   billingAddress: '//input[@id="billing_address_1"]',
   billingCity: '//input[@id="billing_city"]',
